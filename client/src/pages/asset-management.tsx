...
import { Eye, Plus, Package, Filter, QrCode, Paperclip, AlertTriangle, ClipboardCheck, CheckCircle, X, Upload, Trash2, Clock } from "lucide-react";
...
export default function AssetManagement() {
  ...
  const [newMaintenance, setNewMaintenance] = useState({ type: "Inspection", date: "", description: "", cost: "" });
  ...
  const handleAddMaintenance = async () => {
    ...
    setNewMaintenance({ type: "Inspection", date: "", description: "", cost: "" });
  };
              ...
              <div className="mb-3 text-sm text-gray-800 whitespace-pre-wrap">
                                ...
                                <div className="mt-8">
                                  <h3 className="font-bold text-green-800 text-lg flex items-center gap-2">
                                    <Clock className="w-5 h-5" /> Upcoming Tasks / Reminders
                                  </h3>
                                  {tasks.length === 0 ? (
