...
// import { ComplianceDashboard } from "@/features/reports/compliance-dashboard";
...
export default function Reports() {
  ...
  const getActionIcon = (actionType: string) => {
    switch (actionType) {
      case 'SCIENTIFIC_INCIDENT_ANALYSIS':
  ...
  const getEvidenceAuditSummary = (log: AuditLogWithUser) => {
    ...
    return {
      riskBand: typeof data.riskBand === "string" ? data.riskBand : undefined,
      riskScore: typeof data.riskScore === "number" ? data.riskScore : undefined,
      analysisVersion: typeof data.analysisVersion === "string" ? data.analysisVersion : undefined,
    };
  };
