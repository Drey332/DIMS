Here’s your **clean, conflict-free, merged version** — all Git markers removed and both branches fully integrated into one consistent, readable roadmap:
...
| Industry associations       | - IOGP safety flashes and Life-Saving Rules deviations <br> - API incident statistics <br> - ICMM & IMCA safety alerts                                                                                                                                                                                                                         | Cross-operator patterns, human-error precursors, response timing                             |
| Insurance & underwriting    | - Marsh risk engineering bulletins <br> - AIG loss prevention case studies <br> - FM Global property loss prevention data                                                                                                                                                                                                                      | Exposure metrics, estimated loss, recurrence likelihood                                      |
